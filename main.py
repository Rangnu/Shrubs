...
def calculate_score(plant, height_min, height_max, width_min, width_max, selected_colors, selected_climate, average_lifespan, essential_tool):
    score = 0
    ...
    if plant_width_min <= width_max and plant_width_max >= width_min:
        score += 1
...
def find_top_ShrubPlants(all_data, height_min, height_max, width_min, width_max, selected_colors, selected_climate, average_lifespan, essential_tool):
    results = []
    
    # Iterate over each plant in all data
    for plant in all_data:
        score = calculate_score(plant, height_min, height_max, width_min, width_max, selected_colors, selected_climate, average_lifespan, essential_tool)
...
def find_top_plants():
    ...
    try:
        ...
        top_plants = find_top_ShrubPlants(all_data, height_min, height_max, width_min, width_max, selected_colors, selected_climate, average_lifespan, essential_tool)
